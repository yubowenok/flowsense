...
java -cp libsempre/*:lib/* -ea edu.stanford.nlp.sempre.Main -Grammar.inPaths /Users/bowen/smartflow/basic.grammar -Dataset.inPaths test:../smartflow/test/examples.test > test_result
